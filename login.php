...
background: linear-gradient(138deg, rgba(158,64,239,1) 0%, rgba(247,61,96,1) 100%) no-repeat; height: 100vh;">




    <div class="container mt-5" style="background-color: whitesmoke; width:600px;padding: 45px;border-radius: 23px;">
